...
async def async_setup_entry(
    ...
    async def on_device_added(device_sn: str, device_name: str, device_type: str):
        ...
        existing_battery_entity = entity_registry.async_get(battery_sensor_unique_id)
        if not existing_battery_entity:
        ...
        existing_status_entity = entity_registry.async_get(status_sensor_unique_id)
        if not existing_status_entity:
